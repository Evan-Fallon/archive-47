import { $ as DEFAULT_404_COMPONENT, A as GetStaticPathsInvalidRouteParam, B as NoMatchingStaticPathFound, C as ActionNotFoundError, D as ClientAddressNotAvailable, E as CacheNotEnabled, F as LocalsNotAnObject, G as ResponseSentError, H as PrerenderClientAddressNotAvailable, I as LocalsReassigned, J as i18nNoLocaleFoundInPath, K as RewriteWithBodyUsed, L as MiddlewareNoDataOrNextCalled, N as InvalidGetStaticPathsEntry, O as ForbiddenRewrite, P as InvalidGetStaticPathsReturn, Q as ASTRO_GENERATOR, R as MiddlewareNotAResponse, S as isRoute500, T as AstroResponseHeadersReassigned, U as PrerenderDynamicEndpointPathCollide, V as PageNumberParamNotFound, W as ReservedSlotName, X as isAstroError, Y as AstroError, Z as ASTRO_ERROR_HEADER, _ as isAstroComponentFactory, a as chunkToString, at as responseSentSymbol$1, c as renderSlotToString, ct as generateCspDigest, et as REDIRECT_STATUS_CODES, g as pushDirective, h as normalizeCspResourceEntry, it as originPathnameSymbol, j as GetStaticPathsRequired, k as GetStaticPathsExpectedParams, l as isRenderTemplateResult, m as isRenderInstruction, n as renderJSX, nt as clientAddressSymbol, o as createSlotValueFromString, ot as decodeKey, q as StaticClientAddressNotAvailable, r as renderComponent, rt as fetchStateSymbol, st as decryptString, t as renderPage, tt as REROUTABLE_STATUS_CODES, u as renderTemplate, w as ActionsReturnedInvalidDataError, x as isRoute404, y as renderEndpoint, z as NoManifestAvailable } from "./chunks/server_BtBKAhcd.mjs";
	...
	if (i18n && (i18n.strategy === "domains-prefix-always" || i18n.strategy === "domains-prefix-other-locales" || i18n.strategy === "domains-prefix-always-no-redirect")) {
		...
		if (host && protocol) {
			...
			try {
				...
				if (locale) {
					const requestPathname = pathnameFromRequest ?? removeBase$1(url.pathname, base);
...
function removeBase$1(pathname, base) {
...
//#endregion
//#region node_modules/astro/dist/core/manifest/ambient.js
var registered;
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"MODE": "production",
			"PROD": true,
			"PUBLIC_PATH": "C:\\Users\\fallone\\Documents\\Mitty's Everything",
			"SITE": void 0,
			"SSR": true
		}, {
			OS: "Windows_NT",
			Path: "C:\\Users\\fallone\\archive-47\\node_modules\\.bin;C:\\Users\\fallone\\node_modules\\.bin;C:\\Users\\node_modules\\.bin;C:\\node_modules\\.bin;C:\\Program Files\\nodejs\\node_modules\\npm\\node_modules\\@npmcli\\run-script\\lib\\node-gyp-bin;C:\\WINDOWS\\system32;C:\\WINDOWS;C:\\WINDOWS\\System32\\Wbem;C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\;C:\\WINDOWS\\System32\\OpenSSH\\;C:\\Program Files\\NVIDIA Corporation\\NVIDIA App\\NvDLISR;C:\\Program Files (x86)\\NVIDIA Corporation\\PhysX\\Common;C:\\Program Files\\dotnet\\;C:\\Program Files\\Git\\cmd;C:\\Program Files\\nodejs\\;C:\\Users\\fallone\\AppData\\Local\\Programs\\Python\\Python314\\Scripts\\;C:\\Users\\fallone\\AppData\\Local\\Programs\\Python\\Python314\\;C:\\Users\\fallone\\AppData\\Local\\Programs\\Python\\Launcher\\;C:\\Users\\fallone\\AppData\\Local\\Microsoft\\WindowsApps;C:\\Users\\fallone\\AppData\\Local\\Programs\\Obsidian;C:\\Users\\fallone\\AppData\\Local\\GitHubDesktop\\bin;C:\\Users\\fallone\\AppData\\Local\\Programs\\Microsoft VS Code\\bin;C:\\Users\\fallone\\AppData\\Roaming\\npm;C:\\Users\\fallone\\AppData\\Local\\Microsoft\\WinGet\\Links;"
		})?.PROD) return {
...
async function getModuleForRoute$1(manifest, route) {
...
async function getComponentByRoute$1(manifest, routeData) {
	return (await getModuleForRoute$1(manifest, routeData)).page();
}
var productionEnvironment = {
	...
	componentMetadata() {},
	getComponentByRoute: getComponentByRoute$1,
	getModuleForRoute: getModuleForRoute$1,
	async tryRewrite(manifest, payload, request) {
		...
		return {
			newUrl,
			pathname,
			componentInstance: await getComponentByRoute$1(manifest, routeData),
			routeData
		};
	},
...
function removeBase(manifest, pathname) {
	pathname = collapseDuplicateLeadingSlashes(pathname);
	if (pathname.startsWith(manifest.base)) return pathname.slice(removeTrailingForwardSlash(manifest.base).length + 1);
	return pathname;
}
...
function matchRequest(manifest, request, allowPrerenderedRoutes = false) {
	...
	if (!pathname) pathname = prependForwardSlash(removeBase(manifest, url.pathname));
...
[
	{
		...
		"styles": [],
		"routeData": {
			"route": "/cecot-directory",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/cecot-directory\\/?$",
			"segments": [[{
				"content": "cecot-directory",
				"dynamic": false,
				"spread": false
			}]],
			"params": [],
			"component": "src/pages/cecot-directory.astro",
			"pathname": "/cecot-directory",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/cecot-home.astro",
			"pathname": "/cecot-home",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/cecot-summary\\/?$",
			"segments": [[{
				"content": "cecot-summary",
				"dynamic": false,
				"spread": false
			}]],
			"params": [],
			"component": "src/pages/cecot-summary.astro",
			"pathname": "/cecot-summary",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/cecot-timeline",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/cecot-timeline\\/?$",
			"segments": [[{
				"content": "cecot-timeline",
				"dynamic": false,
				"spread": false
			}]],
			"params": [],
			"component": "src/pages/cecot-timeline.astro",
			"pathname": "/cecot-timeline",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/usps-interference-timeline",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/usps-interference-timeline\\/?$",
			"segments": [[{
				"content": "usps-interference-timeline",
				"dynamic": false,
				"spread": false
			}]],
			"params": [],
			"component": "src/pages/usps-interference-timeline.astro",
			"pathname": "/usps-interference-timeline",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
...
var _page0 = () => import("./chunks/cecot-directory_CudXS8eq.mjs");
var _page1 = () => import("./chunks/cecot-home_4PmmMrB0.mjs");
var _page2 = () => import("./chunks/cecot-summary_CPwNq5CM.mjs");
var _page3 = () => import("./chunks/cecot-timeline_BwMRdbJI.mjs");
var _page4 = () => import("./chunks/usps-interference-timeline_VgOnMhu9.mjs");
var _page5 = () => import("./chunks/index_DTklWosA.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["src/pages/cecot-directory.astro", _page0],
	["src/pages/cecot-home.astro", _page1],
	["src/pages/cecot-summary.astro", _page2],
	["src/pages/cecot-timeline.astro", _page3],
	["src/pages/usps-interference-timeline.astro", _page4],
	["src/pages/index.astro", _page5]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///C:/Users/fallone/archive-47/","cacheDir":"file:///C:/Users/fallone/archive-47/node_modules/.astro/","outDir":"file:///C:/Users/fallone/archive-47/dist/","srcDir":"file:///C:/Users/fallone/archive-47/src/","publicDir":"file:///C:/Users/fallone/archive-47/public/","buildClientDir":"file:///C:/Users/fallone/archive-47/dist/client/","buildServerDir":"file:///C:/Users/fallone/archive-47/dist/server/","adapterName":"","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":"\n:root{interpolate-size:allow-keywords}details{max-height:32px;transition:max-height .5s ease-in-out;overflow:hidden;&[open]{max-height:1000px;transition:max-height .5s ease-in-out}}.class-button{color:#fff;background-color:#121212;border:1px solid #333;border-radius:32px;margin:1rem;padding:1rem;font-size:1.2rem;font-weight:500;&:open{border:1px solid #4d4d4d}& ul{margin:8px}}\n.web-header[data-astro-cid-k3sj5lod]{--bg-opac:0;border-bottom:1px solid var(--border-basic);z-index:10;background-color:#0000;place-content:center;width:100%;height:30px;margin:auto;padding:8px;animation-name:rounding;animation-duration:.1s;animation-timing-function:ease-in-out;animation-fill-mode:forwards;animation-timeline:scroll();animation-range:250px 800px;display:flex;position:sticky;top:-100px;& a{color:var(--text-color-important);margin:auto}}@keyframes rounding{0%{background:0 0;width:100%;top:-100px}to{background-color:var(--secondary-bg);border-radius:50px;width:70%;top:10px}}\n:root{color-scheme:light dark}html{height:100%}body{--color-accent:#f19041;--primary-bg:#080808;--secondary-bg:light-dark(#d9d9d9,#0f0f0f);--text-color:light-dark(#4d4d4d,gray);--text-color-important:light-dark(#1a1a1a,#b3b3b3);--border-basic:light-dark(#b3b3b3,#333);--border-hover:light-dark(gray,#4d4d4d);background:var(--primary-bg);width:100%;height:100%;color:var(--text-color);margin:0;overflow:hidden;font-family:Noto Sans!important}h1{text-align:center;color:var(--text-color-important);font-size:4rem;font-weight:1000}.pile{grid-template-areas:\"pile\";place-items:center;display:grid;&>*{grid-area:pile}}.topic-header{height:min-content}.content-scroller{height:100%;max-height:100%;overflow-y:scroll}.content-sizer{height:fit-content;color:var(--text-color);grid-template-columns:1fr 540px 540px 1fr;display:grid;&>*{grid-column:2/4}}\n"}],"routeData":{"route":"/cecot-directory","isIndex":false,"type":"page","pattern":"^\\/cecot-directory\\/?$","segments":[[{"content":"cecot-directory","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/cecot-directory.astro","pathname":"/cecot-directory","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":"\nh1{font-size:4rem;font-weight:1000}.link-holder{gap:2rem;display:flex}.view-link{text-align:center;color:#fff;vertical-align:text-top;width:200px;height:200px;transition-property:border, background-color,;background-color:#0000;border:1px solid #333;border-radius:32px;justify-content:center;align-items:center;padding:2rem;font-size:1.5rem;font-weight:600;text-decoration:none;transition-duration:.8s,2s,2s;transition-timing-function:ease-in-out,ease-in-out,ease-out;display:flex;&:hover{background-color:#121212;border:1px solid #404040;transition-duration:.2s,.5s}}\n.web-header[data-astro-cid-k3sj5lod]{--bg-opac:0;border-bottom:1px solid var(--border-basic);z-index:10;background-color:#0000;place-content:center;width:100%;height:30px;margin:auto;padding:8px;animation-name:rounding;animation-duration:.1s;animation-timing-function:ease-in-out;animation-fill-mode:forwards;animation-timeline:scroll();animation-range:250px 800px;display:flex;position:sticky;top:-100px;& a{color:var(--text-color-important);margin:auto}}@keyframes rounding{0%{background:0 0;width:100%;top:-100px}to{background-color:var(--secondary-bg);border-radius:50px;width:70%;top:10px}}\n:root{color-scheme:light dark}html{height:100%}body{--color-accent:#f19041;--primary-bg:#080808;--secondary-bg:light-dark(#d9d9d9,#0f0f0f);--text-color:light-dark(#4d4d4d,gray);--text-color-important:light-dark(#1a1a1a,#b3b3b3);--border-basic:light-dark(#b3b3b3,#333);--border-hover:light-dark(gray,#4d4d4d);background:var(--primary-bg);width:100%;height:100%;color:var(--text-color);margin:0;overflow:hidden;font-family:Noto Sans!important}h1{text-align:center;color:var(--text-color-important);font-size:4rem;font-weight:1000}.pile{grid-template-areas:\"pile\";place-items:center;display:grid;&>*{grid-area:pile}}.topic-header{height:min-content}.content-scroller{height:100%;max-height:100%;overflow-y:scroll}.content-sizer{height:fit-content;color:var(--text-color);grid-template-columns:1fr 540px 540px 1fr;display:grid;&>*{grid-column:2/4}}\n"}],"routeData":{"route":"/cecot-home","isIndex":false,"type":"page","pattern":"^\\/cecot-home\\/?$","segments":[[{"content":"cecot-home","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/cecot-home.astro","pathname":"/cecot-home","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/cecot-summary","isIndex":false,"type":"page","pattern":"^\\/cecot-summary\\/?$","segments":[[{"content":"cecot-summary","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/cecot-summary.astro","pathname":"/cecot-summary","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":".web-header[data-astro-cid-k3sj5lod]{--bg-opac:0;border-bottom:1px solid var(--border-basic);z-index:10;background-color:#0000;place-content:center;width:100%;height:30px;margin:auto;padding:8px;animation-name:rounding;animation-duration:.1s;animation-timing-function:ease-in-out;animation-fill-mode:forwards;animation-timeline:scroll();animation-range:250px 800px;display:flex;position:sticky;top:-100px;& a{color:var(--text-color-important);margin:auto}}@keyframes rounding{0%{background:0 0;width:100%;top:-100px}to{background-color:var(--secondary-bg);border-radius:50px;width:70%;top:10px}}\n:root{color-scheme:light dark}html{height:100%}body{--color-accent:#f19041;--primary-bg:#080808;--secondary-bg:light-dark(#d9d9d9,#0f0f0f);--text-color:light-dark(#4d4d4d,gray);--text-color-important:light-dark(#1a1a1a,#b3b3b3);--border-basic:light-dark(#b3b3b3,#333);--border-hover:light-dark(gray,#4d4d4d);background:var(--primary-bg);width:100%;height:100%;color:var(--text-color);margin:0;overflow:hidden;font-family:Noto Sans!important}h1{text-align:center;color:var(--text-color-important);font-size:4rem;font-weight:1000}.pile{grid-template-areas:\"pile\";place-items:center;display:grid;&>*{grid-area:pile}}.topic-header{height:min-content}.content-scroller{height:100%;max-height:100%;overflow-y:scroll}.content-sizer{height:fit-content;color:var(--text-color);grid-template-columns:1fr 540px 540px 1fr;display:grid;&>*{grid-column:2/4}}\n.timeline-base{background:var(--secondary-bg);grid-template-columns:min-content auto 40px auto;gap:0;padding:0 2rem;display:grid}.display-node{--title-padding:16px;box-sizing:border-box;margin:16px 0;& .name-link{& a{color:var(--text-color);font-size:1.1em;font-weight:700;text-decoration:none}}&.basic{padding:var(--title-padding);border:1px solid var(--border-basic);background:var(--primary-bg);color:var(--text-color);border-radius:6px;transition-property:border-color;transition-duration:.8s;& a{color:var(--text-color-important)}&:hover{border:1px solid var(--border-hover);transition-duration:50ms}}&.minor{margin:12px 0;& .name-link{align-items:center;gap:.5em;width:fit-content;height:fit-content;display:flex;& a{color:var(--text-color-important);text-box-trim:trim-both;text-box-edge:ex alphabetic;font-size:1em}}}&.image{border:1px solid var(--border-basic);box-sizing:border-box;border-radius:6px;grid-template-areas:\"pile\";max-height:225px;transition-property:border-color;transition-duration:.8s;display:grid;overflow:hidden;&>*{grid-area:pile}& .name-link{background:hsl(from var(--primary-bg) h s l / .8);z-index:1;border-radius:0 0 12px;align-items:center;gap:.5em;width:fit-content;height:fit-content;padding:8px 24px;display:flex;& a{text-box-trim:trim-both;text-box-edge:cap alphabetic;color:var(--text-color-important);font-size:1.1em;font-weight:700;text-decoration:none}}& img{object-fit:cover;object-position:center;width:100%;height:100%;min-height:200px}&:hover{border:1px solid #4d4d4d;transition-duration:50ms}}& .content-embed{padding:8px 0 0;font-size:13px}}.commentary-button,.content-button{opacity:0;background:var(--primary-bg);color:var(--border-hover);border:1px solid hsl(from var(--border-basic) h s l);text-align:center;border-radius:2px;place-content:center;place-items:center;height:1rem;font-size:.8em;font-weight:1000;transition-property:opacity;transition-duration:.25s;display:inline-flex}.node-commentary-popover,.node-content-popover{border:1px solid var(--border-basic);background:var(--primary-bg);max-width:480px;color:var(--text-color);position-area:top;position-try:flip-block;opacity:0;border-radius:6px;margin-bottom:10px;padding:1em;font-family:Noto Sans;font-size:.75em;transition:opacity .2s;&:popover-open{opacity:1;@starting-style{opacity:0}}}.commentary-button,.node-commentary-popover{border-color:var(--color-accent);color:var(--color-accent)}.timeline-cell:hover .commentary-button,.timeline-cell:hover .content-button{opacity:1}.timeline-cell{grid-column:2/3;align-items:center;width:100%;display:grid;&.node{transform-origin:0;animation-name:node-reveal;animation-duration:1s;animation-timing-function:ease-out;animation-fill-mode:both;animation-delay:var(--anim-delay)}&:has(.display-node.image){align-items:inherit;width:calc(100% + 4rem);margin:0 -2rem;grid-column:1/5!important;& .display-node{border-style:solid;border-width:1px 0;border-color:var(--border-basic);border-radius:0}}& p{margin:0}&.year{color:var(--text-color-important);text-align:center;place-items:center;width:calc(100% + 4rem);margin:0 -2rem;font-size:3rem;font-weight:600}& hr{border:none;border-bottom:1px solid #4d4d4d;width:100%;margin:0}&.month{text-align:right;color:var(--text-color);animation-name:opacity-reveal;animation-duration:.8s;animation-timing-function:ease-in;animation-fill-mode:both;animation-delay:var(--anim-delay);margin-top:24px;font-size:1.1rem;font-weight:600}}.timeline-line{background:var(--border-basic);justify-self:center;width:1px;height:calc(100% - 64px);margin:48px 0;animation-name:line-go-down;animation-duration:3s;animation-timing-function:ease-in;animation-fill-mode:both}.node-circles{border:1px solid var(--border-basic);background:var(--secondary-bg);border-radius:20px;place-self:center;width:15px;height:15px}.node-circles{border:1px solid var(--border-basic);background:var(--secondary-bg);width:15px;height:15px;animation-name:opacity-reveal;animation-duration:.5s;animation-timing-function:ease-in;animation-fill-mode:both;animation-delay:var(--anim-delay);border-radius:20px;place-self:center;&.Minor{border:1px solid var(--border-basic);background:var(--secondary-bg);border-radius:15px;width:10px;height:10px}}.node-day-time{color:#4d4d4d;animation-name:opacity-reveal;animation-duration:.5s;animation-timing-function:ease-in;animation-fill-mode:both;animation-delay:var(--anim-delay);place-self:center right;font-size:.8rem}#span-column{grid-template-rows:subgrid;gap:0 4px;width:auto;height:100%;margin-right:8px;display:grid;position:relative}.timeline-span{background:light-dark(hsl(from var(--border-basic) h s l / .3),hsl(from var(--border-basic) h s l / .1));border-color:light-dark(hsl(from var(--border-basic) h s l / 1),hsl(from var(--border-basic) h s l / .4));border-style:solid;border-width:0 1px;width:20px;height:calc(100% - 8px);margin:-48px auto auto 0;transition:border .25s,background .4s;&:hover{border-color:hsl(from var(--border-basic) h s l / .7);background:hsl(from var(--border-basic) h s l / .2);& .span-name{opacity:1;transform:translate(25px)}}}.span-name{opacity:0;pointer-events:none;background:var(--primary-bg);border:1px solid var(--border-basic);width:125px;color:var(--text-color);z-index:2;border-radius:8px;place-self:center;padding:.5em;transition:opacity .1s,transform .3s;position:sticky;top:50%}@keyframes line-go-down{0%{max-height:0%}to{max-height:100%}}\n"}],"routeData":{"route":"/cecot-timeline","isIndex":false,"type":"page","pattern":"^\\/cecot-timeline\\/?$","segments":[[{"content":"cecot-timeline","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/cecot-timeline.astro","pathname":"/cecot-timeline","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":".web-header[data-astro-cid-k3sj5lod]{--bg-opac:0;border-bottom:1px solid var(--border-basic);z-index:10;background-color:#0000;place-content:center;width:100%;height:30px;margin:auto;padding:8px;animation-name:rounding;animation-duration:.1s;animation-timing-function:ease-in-out;animation-fill-mode:forwards;animation-timeline:scroll();animation-range:250px 800px;display:flex;position:sticky;top:-100px;& a{color:var(--text-color-important);margin:auto}}@keyframes rounding{0%{background:0 0;width:100%;top:-100px}to{background-color:var(--secondary-bg);border-radius:50px;width:70%;top:10px}}\n:root{color-scheme:light dark}html{height:100%}body{--color-accent:#f19041;--primary-bg:#080808;--secondary-bg:light-dark(#d9d9d9,#0f0f0f);--text-color:light-dark(#4d4d4d,gray);--text-color-important:light-dark(#1a1a1a,#b3b3b3);--border-basic:light-dark(#b3b3b3,#333);--border-hover:light-dark(gray,#4d4d4d);background:var(--primary-bg);width:100%;height:100%;color:var(--text-color);margin:0;overflow:hidden;font-family:Noto Sans!important}h1{text-align:center;color:var(--text-color-important);font-size:4rem;font-weight:1000}.pile{grid-template-areas:\"pile\";place-items:center;display:grid;&>*{grid-area:pile}}.topic-header{height:min-content}.content-scroller{height:100%;max-height:100%;overflow-y:scroll}.content-sizer{height:fit-content;color:var(--text-color);grid-template-columns:1fr 540px 540px 1fr;display:grid;&>*{grid-column:2/4}}\n.timeline-base{background:var(--secondary-bg);grid-template-columns:min-content auto 40px auto;gap:0;padding:0 2rem;display:grid}.display-node{--title-padding:16px;box-sizing:border-box;margin:16px 0;& .name-link{& a{color:var(--text-color);font-size:1.1em;font-weight:700;text-decoration:none}}&.basic{padding:var(--title-padding);border:1px solid var(--border-basic);background:var(--primary-bg);color:var(--text-color);border-radius:6px;transition-property:border-color;transition-duration:.8s;& a{color:var(--text-color-important)}&:hover{border:1px solid var(--border-hover);transition-duration:50ms}}&.minor{margin:12px 0;& .name-link{align-items:center;gap:.5em;width:fit-content;height:fit-content;display:flex;& a{color:var(--text-color-important);text-box-trim:trim-both;text-box-edge:ex alphabetic;font-size:1em}}}&.image{border:1px solid var(--border-basic);box-sizing:border-box;border-radius:6px;grid-template-areas:\"pile\";max-height:225px;transition-property:border-color;transition-duration:.8s;display:grid;overflow:hidden;&>*{grid-area:pile}& .name-link{background:hsl(from var(--primary-bg) h s l / .8);z-index:1;border-radius:0 0 12px;align-items:center;gap:.5em;width:fit-content;height:fit-content;padding:8px 24px;display:flex;& a{text-box-trim:trim-both;text-box-edge:cap alphabetic;color:var(--text-color-important);font-size:1.1em;font-weight:700;text-decoration:none}}& img{object-fit:cover;object-position:center;width:100%;height:100%;min-height:200px}&:hover{border:1px solid #4d4d4d;transition-duration:50ms}}& .content-embed{padding:8px 0 0;font-size:13px}}.commentary-button,.content-button{opacity:0;background:var(--primary-bg);color:var(--border-hover);border:1px solid hsl(from var(--border-basic) h s l);text-align:center;border-radius:2px;place-content:center;place-items:center;height:1rem;font-size:.8em;font-weight:1000;transition-property:opacity;transition-duration:.25s;display:inline-flex}.node-commentary-popover,.node-content-popover{border:1px solid var(--border-basic);background:var(--primary-bg);max-width:480px;color:var(--text-color);position-area:top;position-try:flip-block;opacity:0;border-radius:6px;margin-bottom:10px;padding:1em;font-family:Noto Sans;font-size:.75em;transition:opacity .2s;&:popover-open{opacity:1;@starting-style{opacity:0}}}.commentary-button,.node-commentary-popover{border-color:var(--color-accent);color:var(--color-accent)}.timeline-cell:hover .commentary-button,.timeline-cell:hover .content-button{opacity:1}.timeline-cell{grid-column:2/3;align-items:center;width:100%;display:grid;&.node{transform-origin:0;animation-name:node-reveal;animation-duration:1s;animation-timing-function:ease-out;animation-fill-mode:both;animation-delay:var(--anim-delay)}&:has(.display-node.image){align-items:inherit;width:calc(100% + 4rem);margin:0 -2rem;grid-column:1/5!important;& .display-node{border-style:solid;border-width:1px 0;border-color:var(--border-basic);border-radius:0}}& p{margin:0}&.year{color:var(--text-color-important);text-align:center;place-items:center;width:calc(100% + 4rem);margin:0 -2rem;font-size:3rem;font-weight:600}& hr{border:none;border-bottom:1px solid #4d4d4d;width:100%;margin:0}&.month{text-align:right;color:var(--text-color);animation-name:opacity-reveal;animation-duration:.8s;animation-timing-function:ease-in;animation-fill-mode:both;animation-delay:var(--anim-delay);margin-top:24px;font-size:1.1rem;font-weight:600}}.timeline-line{background:var(--border-basic);justify-self:center;width:1px;height:calc(100% - 64px);margin:48px 0;animation-name:line-go-down;animation-duration:3s;animation-timing-function:ease-in;animation-fill-mode:both}.node-circles{border:1px solid var(--border-basic);background:var(--secondary-bg);border-radius:20px;place-self:center;width:15px;height:15px}.node-circles{border:1px solid var(--border-basic);background:var(--secondary-bg);width:15px;height:15px;animation-name:opacity-reveal;animation-duration:.5s;animation-timing-function:ease-in;animation-fill-mode:both;animation-delay:var(--anim-delay);border-radius:20px;place-self:center;&.Minor{border:1px solid var(--border-basic);background:var(--secondary-bg);border-radius:15px;width:10px;height:10px}}.node-day-time{color:#4d4d4d;animation-name:opacity-reveal;animation-duration:.5s;animation-timing-function:ease-in;animation-fill-mode:both;animation-delay:var(--anim-delay);place-self:center right;font-size:.8rem}#span-column{grid-template-rows:subgrid;gap:0 4px;width:auto;height:100%;margin-right:8px;display:grid;position:relative}.timeline-span{background:light-dark(hsl(from var(--border-basic) h s l / .3),hsl(from var(--border-basic) h s l / .1));border-color:light-dark(hsl(from var(--border-basic) h s l / 1),hsl(from var(--border-basic) h s l / .4));border-style:solid;border-width:0 1px;width:20px;height:calc(100% - 8px);margin:-48px auto auto 0;transition:border .25s,background .4s;&:hover{border-color:hsl(from var(--border-basic) h s l / .7);background:hsl(from var(--border-basic) h s l / .2);& .span-name{opacity:1;transform:translate(25px)}}}.span-name{opacity:0;pointer-events:none;background:var(--primary-bg);border:1px solid var(--border-basic);width:125px;color:var(--text-color);z-index:2;border-radius:8px;place-self:center;padding:.5em;transition:opacity .1s,transform .3s;position:sticky;top:50%}@keyframes line-go-down{0%{max-height:0%}to{max-height:100%}}\n"}],"routeData":{"route":"/usps-interference-timeline","isIndex":false,"type":"page","pattern":"^\\/usps-interference-timeline\\/?$","segments":[[{"content":"usps-interference-timeline","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/usps-interference-timeline.astro","pathname":"/usps-interference-timeline","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":":root{color-scheme:light dark}html{height:100%}body{--color-accent:#f19041;--primary-bg:#080808;--secondary-bg:light-dark(#d9d9d9,#0f0f0f);--text-color:light-dark(#4d4d4d,gray);--text-color-important:light-dark(#1a1a1a,#b3b3b3);--border-basic:light-dark(#b3b3b3,#333);--border-hover:light-dark(gray,#4d4d4d);background:var(--primary-bg);width:100%;height:100%;color:var(--text-color);margin:0;overflow:hidden;font-family:Noto Sans!important}h1{text-align:center;color:var(--text-color-important);font-size:4rem;font-weight:1000}.pile{grid-template-areas:\"pile\";place-items:center;display:grid;&>*{grid-area:pile}}.topic-header{height:min-content}.content-scroller{height:100%;max-height:100%;overflow-y:scroll}.content-sizer{height:fit-content;color:var(--text-color);grid-template-columns:1fr 540px 540px 1fr;display:grid;&>*{grid-column:2/4}}\n"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":false,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["C:/Users/fallone/archive-47/src/pages/cecot-directory.astro",{"propagation":"none","containsHead":true}],["C:/Users/fallone/archive-47/src/pages/cecot-home.astro",{"propagation":"none","containsHead":true}],["C:/Users/fallone/archive-47/src/pages/cecot-timeline.astro",{"propagation":"none","containsHead":true}],["C:/Users/fallone/archive-47/src/pages/usps-interference-timeline.astro",{"propagation":"none","containsHead":true}],["C:/Users/fallone/archive-47/src/pages/index.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.BxyUSMHA.mjs","\u0000noop-middleware":"chunks/_noop-middleware_CQ50ikAJ.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:page:src/pages/cecot-directory@_@astro":"chunks/cecot-directory_CudXS8eq.mjs","\u0000virtual:astro:page:src/pages/cecot-home@_@astro":"chunks/cecot-home_4PmmMrB0.mjs","\u0000virtual:astro:page:src/pages/cecot-summary@_@astro":"chunks/cecot-summary_CPwNq5CM.mjs","\u0000virtual:astro:page:src/pages/cecot-timeline@_@astro":"chunks/cecot-timeline_BwMRdbJI.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_DTklWosA.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","\u0000virtual:astro:page:src/pages/usps-interference-timeline@_@astro":"chunks/usps-interference-timeline_VgOnMhu9.mjs","virtual:astro:noop":"_astro/_virtual_astro_noop.SBldSjMi.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[],"assets":["/file:///C:/Users/fallone/archive-47/dist/cecot-directory.html","/file:///C:/Users/fallone/archive-47/dist/cecot-home.html","/file:///C:/Users/fallone/archive-47/dist/cecot-summary.html","/file:///C:/Users/fallone/archive-47/dist/cecot-timeline.html","/file:///C:/Users/fallone/archive-47/dist/usps-interference-timeline.html","/file:///C:/Users/fallone/archive-47/dist/index.html"],"buildFormat":"file","checkOrigin":false,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"NT0mCOy3IK8IobwO5Wwpfc4DueQiv9EXJJLoSnaUo3A=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
